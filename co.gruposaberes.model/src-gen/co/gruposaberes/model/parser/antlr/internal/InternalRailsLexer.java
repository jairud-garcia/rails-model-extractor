...
public class InternalRailsLexer extends Lexer {
    ...
    public final void mRULE_COMMA() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1848:12: ( ',' )
            // InternalRails.g:1848:14: ','
            {
            match(','); 
    ...
    public final void mRULE_SPACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1850:12: ( ( ' ' | '\\f' ) )
            // InternalRails.g:1850:14: ( ' ' | '\\f' )
            {
    ...
    public final void mRULE_BRACKET_BLOCK() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1852:20: ( '{' (~ ( ( '{' | '}' ) ) )* ( '{' (~ ( ( '{' | '}' ) ) )* ( '{' (~ ( ( '{' | '}' ) ) )* '}' (~ ( ( '{' | '}' ) ) )* )* '}' (~ ( ( '{' | '}' ) ) )* )* '}' )
            // InternalRails.g:1852:22: '{' (~ ( ( '{' | '}' ) ) )* ( '{' (~ ( ( '{' | '}' ) ) )* ( '{' (~ ( ( '{' | '}' ) ) )* '}' (~ ( ( '{' | '}' ) ) )* )* '}' (~ ( ( '{' | '}' ) ) )* )* '}'
            {
            match('{'); 
            // InternalRails.g:1852:26: (~ ( ( '{' | '}' ) ) )*
            loop1:
            do {
                int alt1=2;
            ...
            do {
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalRails.g:1852:41: '{' (~ ( ( '{' | '}' ) ) )* ( '{' (~ ( ( '{' | '}' ) ) )* '}' (~ ( ( '{' | '}' ) ) )* )* '}' (~ ( ( '{' | '}' ) ) )*
            	    {
            	    match('{'); 
            	    // InternalRails.g:1852:45: (~ ( ( '{' | '}' ) ) )*
            	    loop2:
            	    do {
            	        int alt2=2;
            	    ...
            	    do {
            	        ...
            	        switch (alt5) {
            	    	case 1 :
            	    	    // InternalRails.g:1852:60: '{' (~ ( ( '{' | '}' ) ) )* '}' (~ ( ( '{' | '}' ) ) )*
            	    	    {
            	    	    match('{'); 
            	    	    // InternalRails.g:1852:64: (~ ( ( '{' | '}' ) ) )*
            	    	    loop3:
            	    	    do {
            	    	        int alt3=2;
    ...
    public final void mRULE_ARRAY_BLOCK() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1854:18: ( '[' (~ ( ( '[' | ']' ) ) )* ( '[' (~ ( ( '[' | ']' ) ) )* ( '[' (~ ( ( '[' | ']' ) ) )* ']' (~ ( ( '[' | ']' ) ) )* )* ']' (~ ( ( '[' | ']' ) ) )* )* ']' )
            // InternalRails.g:1854:20: '[' (~ ( ( '[' | ']' ) ) )* ( '[' (~ ( ( '[' | ']' ) ) )* ( '[' (~ ( ( '[' | ']' ) ) )* ']' (~ ( ( '[' | ']' ) ) )* )* ']' (~ ( ( '[' | ']' ) ) )* )* ']'
            {
            match('['); 
            // InternalRails.g:1854:24: (~ ( ( '[' | ']' ) ) )*
            loop8:
            do {
                int alt8=2;
            ...
            do {
                ...
                switch (alt14) {
            	case 1 :
            	    // InternalRails.g:1854:39: '[' (~ ( ( '[' | ']' ) ) )* ( '[' (~ ( ( '[' | ']' ) ) )* ']' (~ ( ( '[' | ']' ) ) )* )* ']' (~ ( ( '[' | ']' ) ) )*
            	    {
            	    match('['); 
            	    // InternalRails.g:1854:43: (~ ( ( '[' | ']' ) ) )*
            	    loop9:
            	    do {
            	        int alt9=2;
            	    ...
            	    do {
            	        ...
            	        switch (alt12) {
            	    	case 1 :
            	    	    // InternalRails.g:1854:58: '[' (~ ( ( '[' | ']' ) ) )* ']' (~ ( ( '[' | ']' ) ) )*
            	    	    {
            	    	    match('['); 
            	    	    // InternalRails.g:1854:62: (~ ( ( '[' | ']' ) ) )*
            	    	    loop10:
            	    	    do {
            	    	        int alt10=2;
    ...
    public final void mRULE_PARENTHESIS_BLOCK() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1856:24: ( '(' (~ ( ( '(' | ')' ) ) )* ( '(' (~ ( ( '(' | ')' ) ) )* ( '(' (~ ( ( '(' | ')' ) ) )* ')' (~ ( ( '(' | ')' ) ) )* )* ')' (~ ( ( '(' | ')' ) ) )* )* (~ ( ( '(' | ')' ) ) )* ')' )
            // InternalRails.g:1856:26: '(' (~ ( ( '(' | ')' ) ) )* ( '(' (~ ( ( '(' | ')' ) ) )* ( '(' (~ ( ( '(' | ')' ) ) )* ')' (~ ( ( '(' | ')' ) ) )* )* ')' (~ ( ( '(' | ')' ) ) )* )* (~ ( ( '(' | ')' ) ) )* ')'
            {
            match('('); 
            // InternalRails.g:1856:30: (~ ( ( '(' | ')' ) ) )*
            loop15:
            do {
                int alt15=2;
            ...
            do {
                ...
                switch (alt21) {
            	case 1 :
            	    // InternalRails.g:1856:45: '(' (~ ( ( '(' | ')' ) ) )* ( '(' (~ ( ( '(' | ')' ) ) )* ')' (~ ( ( '(' | ')' ) ) )* )* ')' (~ ( ( '(' | ')' ) ) )*
            	    {
            	    match('('); 
            	    // InternalRails.g:1856:49: (~ ( ( '(' | ')' ) ) )*
            	    loop16:
            	    do {
            	        int alt16=2;
            	    ...
            	    do {
            	        ...
            	        switch (alt19) {
            	    	case 1 :
            	    	    // InternalRails.g:1856:64: '(' (~ ( ( '(' | ')' ) ) )* ')' (~ ( ( '(' | ')' ) ) )*
            	    	    {
            	    	    match('('); 
            	    	    // InternalRails.g:1856:68: (~ ( ( '(' | ')' ) ) )*
            	    	    loop17:
            	    	    do {
            	    	        int alt17=2;
    ...
    public final void mRULE_DO_BLOCK_PARAMETERS() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1858:26: ( 'do' ( RULE_SPACE )* '|' RULE_ID ( RULE_SPACE )* ( RULE_COMMA ( RULE_SPACE )* RULE_ID )* '|' )
            // InternalRails.g:1858:28: 'do' ( RULE_SPACE )* '|' RULE_ID ( RULE_SPACE )* ( RULE_COMMA ( RULE_SPACE )* RULE_ID )* '|'
            {
            match("do"); 

            // InternalRails.g:1858:33: ( RULE_SPACE )*
            loop23:
            do {
                int alt23=2;
            ...
            match('|'); 
            mRULE_ID(); 
            // InternalRails.g:1858:57: ( RULE_SPACE )*
            loop24:
            do {
                int alt24=2;
            ...
            // InternalRails.g:1858:69: ( RULE_COMMA ( RULE_SPACE )* RULE_ID )*
            loop26:
            do {
                int alt26=2;
                ...
                switch (alt26) {
            	case 1 :
            	    // InternalRails.g:1858:70: RULE_COMMA ( RULE_SPACE )* RULE_ID
            	    {
            	    mRULE_COMMA(); 
            	    // InternalRails.g:1858:81: ( RULE_SPACE )*
            	    loop25:
            	    do {
            	        int alt25=2;
    ...
    public final void mRULE_BELONGS_TO_WORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1860:22: ( 'belongs_to' )
            // InternalRails.g:1860:24: 'belongs_to'
            {
            match("belongs_to"); 
    ...
    public final void mRULE_HAS_MANY_WORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1862:20: ( 'has_many' )
            // InternalRails.g:1862:22: 'has_many'
            {
            match("has_many"); 
    ...
    public final void mRULE_HAS_ONE_WORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1864:19: ( 'has_one' )
            // InternalRails.g:1864:21: 'has_one'
            {
            match("has_one"); 
    ...
    public final void mRULE_HAS_AND_BELONGS_TO_MANY_WORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1866:35: ( 'has_and_belongs_to_many' )
            // InternalRails.g:1866:37: 'has_and_belongs_to_many'
            {
    ...
    public final void mRULE_SET_TABLE_NAME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1868:21: ( 'set_table_name' )
            // InternalRails.g:1868:23: 'set_table_name'
            {
    ...
    public final void mRULE_MODULE_WORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1870:18: ( 'module' )
            // InternalRails.g:1870:20: 'module'
            {
            match("module"); 
    ...
    public final void mRULE_CLASS_WORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1872:17: ( 'class ' )
            // InternalRails.g:1872:19: 'class '
            {
            match("class "); 
    ...
    public final void mRULE_DEF_WORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1874:15: ( 'def' )
            // InternalRails.g:1874:17: 'def'
            {
            match("def"); 
    ...
    public final void mRULE_SYMBOL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1876:13: ( ':' RULE_ID )
            // InternalRails.g:1876:15: ':' RULE_ID
            {
            match(':'); 
            mRULE_ID(); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1878:9: ( ( RULE_CLASS_WORD | ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' | '@' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '!' | '@' | '?' )* ) )
            // InternalRails.g:1878:11: ( RULE_CLASS_WORD | ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' | '@' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '!' | '@' | '?' )* )
            {
            // InternalRails.g:1878:11: ( RULE_CLASS_WORD | ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' | '@' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '!' | '@' | '?' )* )
            int alt28=2;
            ...
            switch (alt28) {
                case 1 :
                    // InternalRails.g:1878:12: RULE_CLASS_WORD
                    {
                    mRULE_CLASS_WORD(); 
                    ...
                    break;
                case 2 :
                    // InternalRails.g:1878:28: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' | '@' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '!' | '@' | '?' )*
                    {
                    ...
                    // InternalRails.g:1878:60: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '!' | '@' | '?' )*
                    loop27:
                    do {
                        int alt27=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1880:13: ( ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | '#' RULE_BRACKET_BLOCK | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalRails.g:1880:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | '#' RULE_BRACKET_BLOCK | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalRails.g:1880:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | '#' RULE_BRACKET_BLOCK | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt31=2;
            ...
            switch (alt31) {
                case 1 :
                    // InternalRails.g:1880:16: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | '#' RULE_BRACKET_BLOCK | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalRails.g:1880:20: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | '#' RULE_BRACKET_BLOCK | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop29:
                    do {
                        int alt29=4;
                        ...
                        switch (alt29) {
                    	case 1 :
                    	    // InternalRails.g:1880:21: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalRails.g:1880:66: '#' RULE_BRACKET_BLOCK
                    	    {
                    	    match('#'); 
                    	    mRULE_BRACKET_BLOCK(); 
                    ...
                    break;
                case 2 :
                    // InternalRails.g:1880:109: '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalRails.g:1880:114: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop30:
                    do {
                        int alt30=3;
                        ...
                        switch (alt30) {
                    	case 1 :
                    	    // InternalRails.g:1880:115: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    	    if ( input.LA(1)=='\"'||input.LA(1)=='\''||input.LA(1)=='\\'||input.LA(1)=='b'||input.LA(1)=='f'||input.LA(1)=='n'||input.LA(1)=='r'||(input.LA(1)>='t' && input.LA(1)<='u') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1882:17: ( '=begin' ( options {greedy=false; } : . )* '=end' )
            // InternalRails.g:1882:19: '=begin' ( options {greedy=false; } : . )* '=end'
            {
            match("=begin"); 

            // InternalRails.g:1882:28: ( options {greedy=false; } : . )*
            loop32:
            do {
                int alt32=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1884:17: ( '#' ( options {greedy=false; } : . )* '\\n' )
            // InternalRails.g:1884:19: '#' ( options {greedy=false; } : . )* '\\n'
            {
            match('#'); 
            // InternalRails.g:1884:23: ( options {greedy=false; } : . )*
            loop33:
            do {
                int alt33=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1886:10: ( ( '0' .. '9' )+ )
            // InternalRails.g:1886:12: ( '0' .. '9' )+
            {
            // InternalRails.g:1886:12: ( '0' .. '9' )+
            int cnt34=0;
            loop34:
    ...
    public final void mRULE_INT_METHOD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1888:17: ( ( '0' .. '9' )+ '.' RULE_ID )
            // InternalRails.g:1888:19: ( '0' .. '9' )+ '.' RULE_ID
            {
            // InternalRails.g:1888:19: ( '0' .. '9' )+
            int cnt35=0;
            loop35:
            do {
                int alt35=2;
    ...
    public final void mRULE_DECIMAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1890:14: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )+ )
            // InternalRails.g:1890:16: ( '0' .. '9' )+ '.' ( '0' .. '9' )+
            {
            // InternalRails.g:1890:16: ( '0' .. '9' )+
            int cnt36=0;
            loop36:
            do {
                int alt36=2;
    ...
    public final void mRULE_REGEXP() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1892:13: ( '/' ( '\\\\/' | ~ ( ( '\\\\/' | RULE_BS ) ) )* '/' ( 'i' | 'o' | 'p' )? )
            // InternalRails.g:1892:15: '/' ( '\\\\/' | ~ ( ( '\\\\/' | RULE_BS ) ) )* '/' ( 'i' | 'o' | 'p' )?
            {
            match('/'); 
            // InternalRails.g:1892:19: ( '\\\\/' | ~ ( ( '\\\\/' | RULE_BS ) ) )*
            loop38:
            do {
                int alt38=3;
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // InternalRails.g:1892:26: ~ ( ( '\\\\/' | RULE_BS ) )
            	    {
    ...
    public final void mRULE_BS() throws RecognitionException {
        try {
            int _type = RULE_BS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1894:9: ( ( '\\t' | '\\n' ) )
            // InternalRails.g:1894:11: ( '\\t' | '\\n' )
            {
    ...
    public final void mRULE_REQUIRE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1896:14: ( 'require' ( RULE_SPACE )* RULE_STRING )
            // InternalRails.g:1896:16: 'require' ( RULE_SPACE )* RULE_STRING
            {
            match("require"); 

            // InternalRails.g:1896:26: ( RULE_SPACE )*
            loop40:
            do {
                int alt40=2;
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:1898:16: ( . )
            // InternalRails.g:1898:18: .
            {
            matchAny(); 
    ...
    class DFA29 extends DFA {
        ...
        public String getDescription() {
            return "()* loopback of 1880:20: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | '#' RULE_BRACKET_BLOCK | ~ ( ( '\\\\' | '\"' ) ) )*";
        }
    ...
    static final String DFA41_eotS =
        "\1\uffff\1\45\1\50\1\53\3\uffff\1\60\1\61\1\uffff\1\67\1\uffff\1\72\1\74\4\uffff\3\42\7\106\3\42\1\121\12\uffff\1\124\31\uffff\2\106\1\uffff\6\106\3\uffff\1\121\5\uffff\1\137\6\106\3\uffff\23\106\1\173\1\uffff\3\106\1\u0080\2\106\2\uffff\2\106\1\u0085\1\uffff\2\106\1\uffff\1\106\1\uffff\2\106\1\u008b\2\106\1\uffff\7\106\1\u0095\1\106\1\uffff\7\106\1\u009e\1\uffff";
    static final String DFA41_eofS =
        "\u009f\uffff";
    static final String DFA41_minS =
        "\1\0\1\74\1\40\1\56\3\uffff\1\52\1\0\1\uffff\1\75\1\uffff\1\174\1\46\4\uffff\3\0\2\145\1\141\1\145\1\157\1\154\1\145\3\0\1\56\12\uffff\1\56\31\uffff\1\14\1\146\1\uffff\1\154\1\163\1\164\1\144\1\141\1\161\2\uffff\1\44\1\56\5\uffff\1\41\1\157\2\137\1\165\1\163\1\165\3\uffff\1\156\1\141\1\164\1\154\1\163\1\151\1\147\1\141\2\156\1\141\1\145\1\40\1\162\1\163\1\156\1\145\1\144\1\142\1\41\1\uffff\1\145\1\137\1\171\1\41\1\137\1\154\2\uffff\1\14\1\164\1\41\1\uffff\1\142\1\145\1\uffff\1\157\1\uffff\1\145\1\137\1\41\1\154\1\156\1\uffff\1\157\1\141\1\156\1\155\1\147\1\145\1\163\1\41\1\137\1\uffff\1\164\1\157\1\137\1\155\1\141\1\156\1\171\1\41\1\uffff";
    static final String DFA41_maxS =
        "\1\uffff\1\75\1\172\1\56\3\uffff\1\52\1\uffff\1\uffff\1\142\1\uffff\1\174\1\46\4\uffff\3\uffff\1\157\1\145\1\141\1\145\1\157\1\154\1\145\3\uffff\1\71\12\uffff\1\56\31\uffff\1\174\1\146\1\uffff\1\154\1\163\1\164\1\144\1\141\1\161\2\uffff\1\172\1\71\5\uffff\1\172\1\157\2\137\1\165\1\163\1\165\3\uffff\1\156\1\157\1\164\1\154\1\163\1\151\1\147\1\141\2\156\1\141\1\145\1\40\1\162\1\163\1\156\1\145\1\144\1\142\1\172\1\uffff\1\145\1\137\1\171\1\172\1\137\1\154\2\uffff\1\47\1\164\1\172\1\uffff\1\142\1\145\1\uffff\1\157\1\uffff\1\145\1\137\1\172\1\154\1\156\1\uffff\1\157\1\141\1\156\1\155\1\147\1\145\1\163\1\172\1\137\1\uffff\1\164\1\157\1\137\1\155\1\141\1\156\1\171\1\172\1\uffff";
    static final String DFA41_acceptS =
        "\4\uffff\1\5\1\6\1\7\2\uffff\1\12\1\uffff\1\15\2\uffff\1\23\1\26\1\33\1\34\16\uffff\1\62\1\52\1\64\1\24\1\25\1\1\1\2\1\4\1\31\1\51\1\uffff\1\3\1\5\1\6\1\7\1\13\1\10\1\11\1\61\1\12\1\22\1\32\1\54\1\14\1\15\1\17\1\16\1\21\1\20\1\23\1\26\1\33\1\34\1\35\1\36\1\37\2\uffff\1\52\6\uffff\1\53\1\55\2\uffff\1\56\1\62\1\30\1\27\1\40\7\uffff\1\60\1\57\1\50\24\uffff\1\47\6\uffff\1\46\1\47\3\uffff\1\43\2\uffff\1\63\1\uffff\1\42\5\uffff\1\41\11\uffff\1\45\10\uffff\1\44";
    static final String DFA41_specialS =
        "\1\3\7\uffff\1\0\11\uffff\1\2\1\5\1\6\7\uffff\1\1\1\7\1\4\u0080\uffff}>";
    static final String[] DFA41_transitionS = {
            "\11\42\2\40\1\42\1\21\23\42\1\21\1\16\1\34\1\36\1\41\1\11\1\15\1\35\1\24\1\42\1\7\1\5\1\20\1\6\1\3\1\10\12\37\1\2\1\42\1\1\1\12\1\17\1\4\33\41\1\23\3\42\1\41\1\42\1\41\1\26\1\32\1\25\3\41\1\27\4\41\1\31\4\41\1\33\1\30\7\41\1\22\1\14\1\42\1\13\uff81\42",
            "\1\43\1\44",
            "\1\47\3\uffff\1\51\25\uffff\1\46\5\uffff\33\51\4\uffff\1\51\1\uffff\32\51",
            "\1\52",
            "",
            "",
            "",
        ...
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    case 0 : 
                        ...
                        s = -1;
                        if ( ((LA41_8>='\u0000' && LA41_8<='\b')||(LA41_8>='\u000B' && LA41_8<='\uFFFF')) ) {s = 50;}
