...
public class RubyClassImpl extends MinimalEObjectImpl.Container implements RubyClass
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RailsPackage.RUBY_CLASS__NAME, oldName, name));
  }
  ...
  public void setSuperType(String newSuperType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RailsPackage.RUBY_CLASS__SUPER_TYPE, oldSuperType, superType));
  }
  ...
  public EList<ClassElement> getClassElements()
  {
    ...
    {
      classElements = new EObjectContainmentEList<ClassElement>(ClassElement.class, this, RailsPackage.RUBY_CLASS__CLASS_ELEMENTS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RailsPackage.RUBY_CLASS__CLASS_ELEMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RailsPackage.RUBY_CLASS__NAME:
        return getName();
      case RailsPackage.RUBY_CLASS__SUPER_TYPE:
        return getSuperType();
      case RailsPackage.RUBY_CLASS__CLASS_ELEMENTS:
