 ...
 * </p>
 * <ul>
 *   <li>{@link co.gruposaberes.model.rails.impl.BelongsToImpl#getName <em>Name</em>}</li>
...
public class BelongsToImpl extends MinimalEObjectImpl.Container implements BelongsTo
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RailsPackage.BELONGS_TO__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RailsPackage.BELONGS_TO__NAME:
        return getName();
      case RailsPackage.BELONGS_TO__OPTIONS:
        return getOptions();
    }
