...
public class RailsSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case RailsPackage.HAS_AND_BELONGS_TO_MANY:
      {
        ...
        T result = caseHasAndBelongsToMany(hasAndBelongsToMany);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      {
        OperationsChain operationsChain = (OperationsChain)theEObject;
        T result = caseOperationsChain(operationsChain);
        if (result == null) result = caseClassElement(operationsChain);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Has And Belongs To Many</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Has And Belongs To Many</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseHasAndBelongsToMany(HasAndBelongsToMany object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Operations Chain</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Operations Chain</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseOperationsChain(OperationsChain object)
  {
    return null;
  }
