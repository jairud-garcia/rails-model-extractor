  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case RailsPackage.HAS_MANY:
      {
        ...
        if (result == null) result = caseRelationship(hasMany);
        if (result == null) result = caseClassElement(hasMany);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case RailsPackage.HAS_AND_BELONGS_TO_MANY:
      {
        ...
        if (result == null) result = caseRelationship(hasAndBelongsToMany);
        if (result == null) result = caseClassElement(hasAndBelongsToMany);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
