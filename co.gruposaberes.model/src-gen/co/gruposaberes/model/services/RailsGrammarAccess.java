...
public class RailsGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class TableNameElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.model.Rails.TableName");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AssignmentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.model.Rails.Assignment");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public RailsGrammarAccess(GrammarProvider grammarProvider) {
		...
		this.tNOT_BRACKET_SEQ = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.model.Rails.NOT_BRACKET_SEQ");
		this.tFIRST_LEVEL_BRACKET_BLOCK = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.model.Rails.FIRST_LEVEL_BRACKET_BLOCK");
		this.tSECOND_LEVEL_BRACKET_BLOCK = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.model.Rails.SECOND_LEVEL_BRACKET_BLOCK");
		this.tTHIRD_LEVEL_BRACKET_BLOCK = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.model.Rails.THIRD_LEVEL_BRACKET_BLOCK");
		this.tBRACKET_BLOCK = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.model.Rails.BRACKET_BLOCK");
		this.tNOT_ARRAY_SEQ = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.model.Rails.NOT_ARRAY_SEQ");
		this.tFIRST_LEVEL_ARRAY_BLOCK = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.model.Rails.FIRST_LEVEL_ARRAY_BLOCK");
		this.tSECOND_LEVEL_ARRAY_BLOCK = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.model.Rails.SECOND_LEVEL_ARRAY_BLOCK");
		this.tTHIRD_LEVEL_ARRAY_BLOCK = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.model.Rails.THIRD_LEVEL_ARRAY_BLOCK");
		this.tARRAY_BLOCK = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.model.Rails.ARRAY_BLOCK");
		this.tNOT_PARENTHESIS_SEQ = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.model.Rails.NOT_PARENTHESIS_SEQ");
		this.tFIRST_LEVEL_PARENTHESIS_BLOCK = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.model.Rails.FIRST_LEVEL_PARENTHESIS_BLOCK");
		this.tSECOND_LEVEL_PARENTHESIS_BLOCK = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.model.Rails.SECOND_LEVEL_PARENTHESIS_BLOCK");
		this.tTHIRD_LEVEL_PARENTHESIS_BLOCK = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.model.Rails.THIRD_LEVEL_PARENTHESIS_BLOCK");
		...
		this.tLF = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.model.Rails.LF");
		this.tCR = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.model.Rails.CR");
