...
/**
 * This is the item provider adapter for a {@link universal.visualization.VClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VClassItemProvider extends VContainerItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VClass_isShared_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VClass_isShared_feature", "_UI_VClass_type"),
				 VisualizationPackage.Literals.VCLASS__IS_SHARED,
				 true,
				 false,
				 false,
