...
/**
 * This is the item provider adapter for a {@link universal.rails.RailsAssociation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RailsAssociationItemProvider extends RelationItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RailsPackage.Literals.RAILS_ASSOCIATION__ASSOCIATION_TYPE,
				 true,
				 false,
				 false,
	...
	protected void addSourceNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RailsAssociation_sourceName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RailsAssociation_sourceName_feature", "_UI_RailsAssociation_type"),
				 RailsPackage.Literals.RAILS_ASSOCIATION__SOURCE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTargetNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RailsAssociation_targetName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RailsAssociation_targetName_feature", "_UI_RailsAssociation_type"),
				 RailsPackage.Literals.RAILS_ASSOCIATION__TARGET_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addForeignKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RailsAssociation_foreignKey_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RailsAssociation_foreignKey_feature", "_UI_RailsAssociation_type"),
				 RailsPackage.Literals.RAILS_ASSOCIATION__FOREIGN_KEY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((RailsAssociation)object).getSourceName();
