...
/**
 * This is the item provider adapter for a {@link universal.core.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addMeasurantPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_measurant_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_measurant_feature", "_UI_Element_type"),
				 CorePackage.Literals.ELEMENT__MEASURANT,
				 true,
				 false,
				 true,
				 null,
