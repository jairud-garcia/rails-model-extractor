 ...
 * </p>
 * <ul>
 *   <li>{@link universal.rails.impl.RailsMethodImpl#getMethodType <em>Method Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RailsMethodImpl extends SimpleElementImpl implements RailsMethod {
	/**
	...
	protected EClass eStaticClass() {
		return RailsPackage.Literals.RAILS_METHOD;
	}
	...
	public void setMethodType(String newMethodType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RailsPackage.RAILS_METHOD__METHOD_TYPE, oldMethodType, methodType));
	}
