	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RailsPackage.RAILS_APPLICATION: {
				...
				if (result == null) result = caseApplication(railsApplication);
			...
			case RailsPackage.RAILS_ASSOCIATION: {
				...
				if (result == null) result = caseRelation(railsAssociation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RailsPackage.RAILS_NAMESPACE: {
				...
				if (result == null) result = caseContainer(railsNamespace);
				if (result == null) result = caseElement(railsNamespace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RailsPackage.RAILS_CLASS: {
				...
				if (result == null) result = caseContainer(railsClass);
				if (result == null) result = caseElement(railsClass);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RailsPackage.RAILS_METHOD: {
				...
				if (result == null) result = caseSimpleElement(railsMethod);
				if (result == null) result = caseElement(railsMethod);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RailsPackage.RAILS_ATTRIBUTE: {
				...
				if (result == null) result = caseSimpleElement(railsAttribute);
				if (result == null) result = caseElement(railsAttribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
