 ...
 * </p>
 * <ul>
 *   <li>{@link universal.rails.RailsAssociation#getAssociationType <em>Association Type</em>}</li>
 *   <li>{@link universal.rails.RailsAssociation#getSourceName <em>Source Name</em>}</li>
 *   <li>{@link universal.rails.RailsAssociation#getTargetName <em>Target Name</em>}</li>
 *   <li>{@link universal.rails.RailsAssociation#getForeignKey <em>Foreign Key</em>}</li>
 * </ul>
 *
 * @see universal.rails.RailsPackage#getRailsAssociation()
 ...
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot associationTypeInvariant='self.associationType = null or \n\t\t\t\tself.associationType = \'M2M\' or self.associationType = \'O2M\' or self.associationType = \'O2O\'' sourceInvariant='self.source.oclIsTypeOf(RailsClass)=true' targetInvariant='self.target.oclIsTypeOf(RailsClass)=true'"
 * @generated
 */
public interface RailsAssociation extends Relation {
	/**
	 ...
	 * @see universal.rails.RailsPackage#getRailsAssociation_AssociationType()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link universal.rails.RailsAssociation#getAssociationType <em>Association Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see universal.rails.RailsPackage#getRailsAssociation_SourceName()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link universal.rails.RailsAssociation#getSourceName <em>Source Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see universal.rails.RailsPackage#getRailsAssociation_TargetName()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link universal.rails.RailsAssociation#getTargetName <em>Target Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see universal.rails.RailsPackage#getRailsAssociation_ForeignKey()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link universal.rails.RailsAssociation#getForeignKey <em>Foreign Key</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
