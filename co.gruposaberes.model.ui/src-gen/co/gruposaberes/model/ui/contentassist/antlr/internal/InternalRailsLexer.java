...
public class InternalRailsLexer extends Lexer {
    ...
    public final void mRULE_COMMA() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4409:12: ( ',' )
            // InternalRails.g:4409:14: ','
            {
            match(','); 
    ...
    public final void mRULE_SPACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4411:12: ( ( ' ' | '\\f' ) )
            // InternalRails.g:4411:14: ( ' ' | '\\f' )
            {
    ...
    public final void mRULE_BRACKET_BLOCK() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4413:20: ( '{' (~ ( ( '{' | '}' ) ) )* ( '{' (~ ( ( '{' | '}' ) ) )* ( '{' (~ ( ( '{' | '}' ) ) )* '}' (~ ( ( '{' | '}' ) ) )* )* '}' (~ ( ( '{' | '}' ) ) )* )* '}' )
            // InternalRails.g:4413:22: '{' (~ ( ( '{' | '}' ) ) )* ( '{' (~ ( ( '{' | '}' ) ) )* ( '{' (~ ( ( '{' | '}' ) ) )* '}' (~ ( ( '{' | '}' ) ) )* )* '}' (~ ( ( '{' | '}' ) ) )* )* '}'
            {
            match('{'); 
            // InternalRails.g:4413:26: (~ ( ( '{' | '}' ) ) )*
            loop1:
            do {
                int alt1=2;
            ...
            do {
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalRails.g:4413:41: '{' (~ ( ( '{' | '}' ) ) )* ( '{' (~ ( ( '{' | '}' ) ) )* '}' (~ ( ( '{' | '}' ) ) )* )* '}' (~ ( ( '{' | '}' ) ) )*
            	    {
            	    match('{'); 
            	    // InternalRails.g:4413:45: (~ ( ( '{' | '}' ) ) )*
            	    loop2:
            	    do {
            	        int alt2=2;
            	    ...
            	    do {
            	        ...
            	        switch (alt5) {
            	    	case 1 :
            	    	    // InternalRails.g:4413:60: '{' (~ ( ( '{' | '}' ) ) )* '}' (~ ( ( '{' | '}' ) ) )*
            	    	    {
            	    	    match('{'); 
            	    	    // InternalRails.g:4413:64: (~ ( ( '{' | '}' ) ) )*
            	    	    loop3:
            	    	    do {
            	    	        int alt3=2;
    ...
    public final void mRULE_ARRAY_BLOCK() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4415:18: ( '[' (~ ( ( '[' | ']' ) ) )* ( '[' (~ ( ( '[' | ']' ) ) )* ( '[' (~ ( ( '[' | ']' ) ) )* ']' (~ ( ( '[' | ']' ) ) )* )* ']' (~ ( ( '[' | ']' ) ) )* )* ']' )
            // InternalRails.g:4415:20: '[' (~ ( ( '[' | ']' ) ) )* ( '[' (~ ( ( '[' | ']' ) ) )* ( '[' (~ ( ( '[' | ']' ) ) )* ']' (~ ( ( '[' | ']' ) ) )* )* ']' (~ ( ( '[' | ']' ) ) )* )* ']'
            {
            match('['); 
            // InternalRails.g:4415:24: (~ ( ( '[' | ']' ) ) )*
            loop8:
            do {
                int alt8=2;
            ...
            do {
                ...
                switch (alt14) {
            	case 1 :
            	    // InternalRails.g:4415:39: '[' (~ ( ( '[' | ']' ) ) )* ( '[' (~ ( ( '[' | ']' ) ) )* ']' (~ ( ( '[' | ']' ) ) )* )* ']' (~ ( ( '[' | ']' ) ) )*
            	    {
            	    match('['); 
            	    // InternalRails.g:4415:43: (~ ( ( '[' | ']' ) ) )*
            	    loop9:
            	    do {
            	        int alt9=2;
            	    ...
            	    do {
            	        ...
            	        switch (alt12) {
            	    	case 1 :
            	    	    // InternalRails.g:4415:58: '[' (~ ( ( '[' | ']' ) ) )* ']' (~ ( ( '[' | ']' ) ) )*
            	    	    {
            	    	    match('['); 
            	    	    // InternalRails.g:4415:62: (~ ( ( '[' | ']' ) ) )*
            	    	    loop10:
            	    	    do {
            	    	        int alt10=2;
    ...
    public final void mRULE_PARENTHESIS_BLOCK() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4417:24: ( '(' (~ ( ( '(' | ')' ) ) )* ( '(' (~ ( ( '(' | ')' ) ) )* ( '(' (~ ( ( '(' | ')' ) ) )* ')' (~ ( ( '(' | ')' ) ) )* )* ')' (~ ( ( '(' | ')' ) ) )* )* ')' )
            // InternalRails.g:4417:26: '(' (~ ( ( '(' | ')' ) ) )* ( '(' (~ ( ( '(' | ')' ) ) )* ( '(' (~ ( ( '(' | ')' ) ) )* ')' (~ ( ( '(' | ')' ) ) )* )* ')' (~ ( ( '(' | ')' ) ) )* )* ')'
            {
            match('('); 
            // InternalRails.g:4417:30: (~ ( ( '(' | ')' ) ) )*
            loop15:
            do {
                int alt15=2;
            ...
            do {
                ...
                switch (alt21) {
            	case 1 :
            	    // InternalRails.g:4417:45: '(' (~ ( ( '(' | ')' ) ) )* ( '(' (~ ( ( '(' | ')' ) ) )* ')' (~ ( ( '(' | ')' ) ) )* )* ')' (~ ( ( '(' | ')' ) ) )*
            	    {
            	    match('('); 
            	    // InternalRails.g:4417:49: (~ ( ( '(' | ')' ) ) )*
            	    loop16:
            	    do {
            	        int alt16=2;
            	    ...
            	    do {
            	        ...
            	        switch (alt19) {
            	    	case 1 :
            	    	    // InternalRails.g:4417:64: '(' (~ ( ( '(' | ')' ) ) )* ')' (~ ( ( '(' | ')' ) ) )*
            	    	    {
            	    	    match('('); 
            	    	    // InternalRails.g:4417:68: (~ ( ( '(' | ')' ) ) )*
            	    	    loop17:
            	    	    do {
            	    	        int alt17=2;
    ...
    public final void mRULE_DO_BLOCK_PARAMETERS() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4419:26: ( 'do' ( RULE_SPACE )* '|' RULE_ID ( RULE_SPACE )* ( RULE_COMMA ( RULE_SPACE )* RULE_ID )* '|' )
            // InternalRails.g:4419:28: 'do' ( RULE_SPACE )* '|' RULE_ID ( RULE_SPACE )* ( RULE_COMMA ( RULE_SPACE )* RULE_ID )* '|'
            {
            match("do"); 

            // InternalRails.g:4419:33: ( RULE_SPACE )*
            loop22:
            do {
                int alt22=2;
            ...
            match('|'); 
            mRULE_ID(); 
            // InternalRails.g:4419:57: ( RULE_SPACE )*
            loop23:
            do {
                int alt23=2;
            ...
            // InternalRails.g:4419:69: ( RULE_COMMA ( RULE_SPACE )* RULE_ID )*
            loop25:
            do {
                int alt25=2;
                ...
                switch (alt25) {
            	case 1 :
            	    // InternalRails.g:4419:70: RULE_COMMA ( RULE_SPACE )* RULE_ID
            	    {
            	    mRULE_COMMA(); 
            	    // InternalRails.g:4419:81: ( RULE_SPACE )*
            	    loop24:
            	    do {
            	        int alt24=2;
    ...
    public final void mRULE_BELONGS_TO_WORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4421:22: ( 'belongs_to' )
            // InternalRails.g:4421:24: 'belongs_to'
            {
            match("belongs_to"); 
    ...
    public final void mRULE_HAS_MANY_WORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4423:20: ( 'has_many' )
            // InternalRails.g:4423:22: 'has_many'
            {
            match("has_many"); 
    ...
    public final void mRULE_HAS_ONE_WORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4425:19: ( 'has_one' )
            // InternalRails.g:4425:21: 'has_one'
            {
            match("has_one"); 
    ...
    public final void mRULE_HAS_AND_BELONGS_TO_MANY_WORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4427:35: ( 'has_and_belongs_to_many' )
            // InternalRails.g:4427:37: 'has_and_belongs_to_many'
            {
    ...
    public final void mRULE_MODULE_WORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4429:18: ( 'module' )
            // InternalRails.g:4429:20: 'module'
            {
            match("module"); 
    ...
    public final void mRULE_CLASS_WORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4431:17: ( 'class ' )
            // InternalRails.g:4431:19: 'class '
            {
            match("class "); 
    ...
    public final void mRULE_DEF_WORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4433:15: ( 'def' )
            // InternalRails.g:4433:17: 'def'
            {
            match("def"); 
    ...
    public final void mRULE_SYMBOL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4435:13: ( ':' RULE_ID )
            // InternalRails.g:4435:15: ':' RULE_ID
            {
            match(':'); 
            mRULE_ID(); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4437:9: ( ( RULE_CLASS_WORD | ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' | '@' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '!' | '@' | '?' )* ) )
            // InternalRails.g:4437:11: ( RULE_CLASS_WORD | ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' | '@' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '!' | '@' | '?' )* )
            {
            // InternalRails.g:4437:11: ( RULE_CLASS_WORD | ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' | '@' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '!' | '@' | '?' )* )
            int alt27=2;
            ...
            switch (alt27) {
                case 1 :
                    // InternalRails.g:4437:12: RULE_CLASS_WORD
                    {
                    mRULE_CLASS_WORD(); 
                    ...
                    break;
                case 2 :
                    // InternalRails.g:4437:28: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' | '@' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '!' | '@' | '?' )*
                    {
                    ...
                    // InternalRails.g:4437:60: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '!' | '@' | '?' )*
                    loop26:
                    do {
                        int alt26=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4439:13: ( ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | '#' RULE_BRACKET_BLOCK | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalRails.g:4439:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | '#' RULE_BRACKET_BLOCK | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalRails.g:4439:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | '#' RULE_BRACKET_BLOCK | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt30=2;
            ...
            switch (alt30) {
                case 1 :
                    // InternalRails.g:4439:16: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | '#' RULE_BRACKET_BLOCK | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalRails.g:4439:20: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | '#' RULE_BRACKET_BLOCK | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop28:
                    do {
                        int alt28=4;
                        ...
                        switch (alt28) {
                    	case 1 :
                    	    // InternalRails.g:4439:21: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalRails.g:4439:66: '#' RULE_BRACKET_BLOCK
                    	    {
                    	    match('#'); 
                    	    mRULE_BRACKET_BLOCK(); 
                    ...
                    break;
                case 2 :
                    // InternalRails.g:4439:109: '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalRails.g:4439:114: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop29:
                    do {
                        int alt29=3;
                        ...
                        switch (alt29) {
                    	case 1 :
                    	    // InternalRails.g:4439:115: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    	    if ( input.LA(1)=='\"'||input.LA(1)=='\''||input.LA(1)=='\\'||input.LA(1)=='b'||input.LA(1)=='f'||input.LA(1)=='n'||input.LA(1)=='r'||(input.LA(1)>='t' && input.LA(1)<='u') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4441:17: ( '=begin' ( options {greedy=false; } : . )* '=end' )
            // InternalRails.g:4441:19: '=begin' ( options {greedy=false; } : . )* '=end'
            {
            match("=begin"); 

            // InternalRails.g:4441:28: ( options {greedy=false; } : . )*
            loop31:
            do {
                int alt31=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4443:17: ( '#' ( options {greedy=false; } : . )* '\\n' )
            // InternalRails.g:4443:19: '#' ( options {greedy=false; } : . )* '\\n'
            {
            match('#'); 
            // InternalRails.g:4443:23: ( options {greedy=false; } : . )*
            loop32:
            do {
                int alt32=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4445:10: ( ( '0' .. '9' )+ )
            // InternalRails.g:4445:12: ( '0' .. '9' )+
            {
            // InternalRails.g:4445:12: ( '0' .. '9' )+
            int cnt33=0;
            loop33:
    ...
    public final void mRULE_INT_METHOD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4447:17: ( ( '0' .. '9' )+ '.' RULE_ID )
            // InternalRails.g:4447:19: ( '0' .. '9' )+ '.' RULE_ID
            {
            // InternalRails.g:4447:19: ( '0' .. '9' )+
            int cnt34=0;
            loop34:
            do {
                int alt34=2;
    ...
    public final void mRULE_DECIMAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4449:14: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )+ )
            // InternalRails.g:4449:16: ( '0' .. '9' )+ '.' ( '0' .. '9' )+
            {
            // InternalRails.g:4449:16: ( '0' .. '9' )+
            int cnt35=0;
            loop35:
            do {
                int alt35=2;
    ...
    public final void mRULE_REGEXP() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4451:13: ( '/' ( '\\\\/' | ~ ( ( '\\\\/' | RULE_BS ) ) )* '/' ( 'i' | 'o' | 'p' )? )
            // InternalRails.g:4451:15: '/' ( '\\\\/' | ~ ( ( '\\\\/' | RULE_BS ) ) )* '/' ( 'i' | 'o' | 'p' )?
            {
            match('/'); 
            // InternalRails.g:4451:19: ( '\\\\/' | ~ ( ( '\\\\/' | RULE_BS ) ) )*
            loop37:
            do {
                int alt37=3;
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // InternalRails.g:4451:26: ~ ( ( '\\\\/' | RULE_BS ) )
            	    {
    ...
    public final void mRULE_BS() throws RecognitionException {
        try {
            int _type = RULE_BS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4453:9: ( ( '\\t' | '\\n' ) )
            // InternalRails.g:4453:11: ( '\\t' | '\\n' )
            {
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRails.g:4455:16: ( . )
            // InternalRails.g:4455:18: .
            {
            matchAny(); 
    ...
    class DFA28 extends DFA {
        ...
        public String getDescription() {
            return "()* loopback of 4439:20: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | '#' RULE_BRACKET_BLOCK | ~ ( ( '\\\\' | '\"' ) ) )*";
        }
    ...
    static final String DFA39_eotS =
        "\1\uffff\1\43\1\uffff\1\50\2\uffff\1\54\1\55\1\uffff\1\63\1\uffff\1\66\1\70\2\uffff\1\74\2\uffff\3\40\5\104\1\uffff\3\40\1\115\34\uffff\1\120\6\uffff\2\104\1\uffff\4\104\3\uffff\1\115\5\uffff\1\131\4\104\3\uffff\16\104\1\156\1\uffff\2\104\1\162\1\104\2\uffff\1\104\1\165\1\uffff\2\104\1\uffff\1\104\1\171\1\104\1\uffff\14\104\1\u0087\1\uffff";
    static final String DFA39_eofS =
        "\u0088\uffff";
    static final String DFA39_minS =
        "\1\0\1\40\1\uffff\1\74\2\uffff\1\52\1\0\1\uffff\1\75\1\uffff\1\174\1\46\2\uffff\1\56\2\uffff\3\0\2\145\1\141\1\157\1\154\1\uffff\3\0\1\56\34\uffff\1\56\6\uffff\1\14\1\146\1\uffff\1\154\1\163\1\144\1\141\2\uffff\1\44\1\56\5\uffff\1\41\1\157\1\137\1\165\1\163\3\uffff\1\156\1\141\1\154\1\163\1\147\1\141\2\156\1\145\1\40\1\163\1\156\1\145\1\144\1\41\1\uffff\1\137\1\171\1\41\1\137\2\uffff\1\164\1\41\1\uffff\1\142\1\157\1\uffff\1\145\1\41\1\154\1\uffff\1\157\1\156\1\147\1\163\1\137\1\164\1\157\1\137\1\155\1\141\1\156\1\171\1\41\1\uffff";
    static final String DFA39_maxS =
        "\1\uffff\1\172\1\uffff\1\75\2\uffff\1\52\1\uffff\1\uffff\1\142\1\uffff\1\174\1\46\2\uffff\1\56\2\uffff\3\uffff\1\157\1\145\1\141\1\157\1\154\1\uffff\3\uffff\1\71\34\uffff\1\56\6\uffff\1\174\1\146\1\uffff\1\154\1\163\1\144\1\141\2\uffff\1\172\1\71\5\uffff\1\172\1\157\1\137\1\165\1\163\3\uffff\1\156\1\157\1\154\1\163\1\147\1\141\2\156\1\145\1\40\1\163\1\156\1\145\1\144\1\172\1\uffff\1\137\1\171\1\172\1\137\2\uffff\1\164\1\172\1\uffff\1\142\1\157\1\uffff\1\145\1\172\1\154\1\uffff\1\157\1\156\1\147\1\163\1\137\1\164\1\157\1\137\1\155\1\141\1\156\1\171\1\172\1\uffff";
    static final String DFA39_acceptS =
        "\2\uffff\1\2\1\uffff\1\4\1\5\2\uffff\1\10\1\uffff\1\13\2\uffff\1\21\1\24\1\uffff\1\33\1\34\10\uffff\1\51\4\uffff\1\61\1\62\1\1\1\27\1\31\1\50\1\2\1\22\1\23\1\3\1\4\1\5\1\11\1\6\1\7\1\60\1\10\1\20\1\32\1\53\1\12\1\13\1\15\1\14\1\17\1\16\1\21\1\24\1\uffff\1\30\1\33\1\34\1\35\1\36\1\37\2\uffff\1\51\4\uffff\1\52\1\54\2\uffff\1\55\1\61\1\26\1\25\1\40\5\uffff\1\57\1\56\1\47\17\uffff\1\46\4\uffff\1\45\1\46\2\uffff\1\43\2\uffff\1\42\3\uffff\1\41\15\uffff\1\44";
    static final String DFA39_specialS =
        "\1\6\6\uffff\1\7\12\uffff\1\4\1\5\1\0\6\uffff\1\3\1\2\1\1\152\uffff}>";
    static final String[] DFA39_transitionS = {
            "\11\40\2\37\1\40\1\21\23\40\1\21\1\15\1\33\1\35\1\32\1\10\1\14\1\34\1\24\1\40\1\6\1\4\1\20\1\5\1\17\1\7\12\36\1\1\1\40\1\3\1\11\1\16\1\2\33\32\1\23\3\40\1\32\1\40\1\32\1\26\1\31\1\25\3\32\1\27\4\32\1\30\15\32\1\22\1\13\1\40\1\12\uff81\40",
            "\1\41\3\uffff\1\44\25\uffff\1\42\5\uffff\33\44\4\uffff\1\44\1\uffff\32\44",
            "",
            "\1\46\1\47",
            "",
            "",
        ...
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    ...
                    case 7 : 
                        ...
                        s = -1;
                        if ( ((LA39_7>='\u0000' && LA39_7<='\b')||(LA39_7>='\u000B' && LA39_7<='\uFFFF')) ) {s = 46;}
