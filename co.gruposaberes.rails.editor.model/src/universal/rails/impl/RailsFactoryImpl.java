...
public class RailsFactoryImpl extends EFactoryImpl implements RailsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case RailsPackage.ASSOCIATION: return createAssociation();
			case RailsPackage.NAMESPACE: return createNamespace();
			case RailsPackage.RUBY_CLASS: return createRubyClass();
			case RailsPackage.METHOD: return createMethod();
			case RailsPackage.ATTRIBUTE: return createAttribute();
			default:
