 ...
 * </p>
 * <ul>
 *   <li>{@link universal.rails.impl.RubyClassImpl#getSuperClass <em>Super Class</em>}</li>
 *   <li>{@link universal.rails.impl.RubyClassImpl#getFullName <em>Full Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RubyClassImpl extends ContainerImpl implements RubyClass {
	/**
	...
	protected EClass eStaticClass() {
		return RailsPackage.Literals.RUBY_CLASS;
	}
	...
	public void setSuperClass(String newSuperClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RailsPackage.RUBY_CLASS__SUPER_CLASS, oldSuperClass, superClass));
	}
	...
	public void setFullName(String newFullName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RailsPackage.RUBY_CLASS__FULL_NAME, oldFullName, fullName));
	}
