 ...
 * </p>
 * <ul>
 *   <li>{@link universal.rails.impl.AssociationImpl#getAssociationType <em>Association Type</em>}</li>
 *   <li>{@link universal.rails.impl.AssociationImpl#getSourceName <em>Source Name</em>}</li>
 *   <li>{@link universal.rails.impl.AssociationImpl#getTargetName <em>Target Name</em>}</li>
 *   <li>{@link universal.rails.impl.AssociationImpl#getForeignKey <em>Foreign Key</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssociationImpl extends RelationImpl implements Association {
	...
	protected EClass eStaticClass() {
		return RailsPackage.Literals.ASSOCIATION;
	}
	...
	public void setAssociationType(String newAssociationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RailsPackage.ASSOCIATION__ASSOCIATION_TYPE, oldAssociationType, associationType));
	}
	...
	public void setSourceName(String newSourceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RailsPackage.ASSOCIATION__SOURCE_NAME, oldSourceName, sourceName));
	}
	...
	public void setTargetName(String newTargetName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RailsPackage.ASSOCIATION__TARGET_NAME, oldTargetName, targetName));
	}
	...
	public void setForeignKey(String newForeignKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RailsPackage.ASSOCIATION__FOREIGN_KEY, oldForeignKey, foreignKey));
	}
