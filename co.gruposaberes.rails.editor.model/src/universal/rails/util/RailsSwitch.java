...
public class RailsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RailsPackage.APPLICATION: {
				...
				if (result == null) result = caseCore_Application(application);
			...
			case RailsPackage.NAMESPACE: {
				...
				if (result == null) result = caseContainer(namespace);
			...
			case RailsPackage.RUBY_CLASS: {
				...
				if (result == null) result = caseContainer(rubyClass);
				if (result == null) result = caseElement(rubyClass);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case RailsPackage.ATTRIBUTE: {
				...
				if (result == null) result = caseSimpleElement(attribute);
	 ...
	 * @generated
	 */
	public T caseCore_Application(universal.core.Application object) {
		return null;
	}
