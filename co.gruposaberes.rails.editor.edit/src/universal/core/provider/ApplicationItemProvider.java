...
public class ApplicationItemProvider 
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.APPLICATION__BASIC_ELEMENTS,
				 RailsFactory.eINSTANCE.createNamespace()));

		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.APPLICATION__BASIC_ELEMENTS,
				 RailsFactory.eINSTANCE.createRubyClass()));

		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.APPLICATION__BASIC_ELEMENTS,
				 RailsFactory.eINSTANCE.createMethod()));

		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.APPLICATION__BASIC_ELEMENTS,
				 RailsFactory.eINSTANCE.createAttribute()));
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.APPLICATION__SIMPLE_RELATIONSHIPS,
				 RailsFactory.eINSTANCE.createAssociation()));
	}
