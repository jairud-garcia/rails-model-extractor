 ...
 * </p>
 * <ul>
 *   <li>{@link co.gruposaberes.rails.parser.models.impl.RelationshipImpl#getRelationType <em>Relation Type</em>}</li>
 *   <li>{@link co.gruposaberes.rails.parser.models.impl.RelationshipImpl#getOptions <em>Options</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationshipImpl extends ClassElementImpl implements Relationship
{
  ...
  {
    return ModelsPackage.Literals.RELATIONSHIP;
  }
  ...
  public void setRelationType(String newRelationType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelsPackage.RELATIONSHIP__RELATION_TYPE, oldRelationType, relationType));
  }
  ...
  public EList<HashKeyValue> getOptions()
  {
    if (options == null)
    {
      options = new EObjectContainmentEList<HashKeyValue>(HashKeyValue.class, this, ModelsPackage.RELATIONSHIP__OPTIONS);
    }
    return options;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ModelsPackage.RELATIONSHIP__OPTIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ModelsPackage.RELATIONSHIP__RELATION_TYPE:
