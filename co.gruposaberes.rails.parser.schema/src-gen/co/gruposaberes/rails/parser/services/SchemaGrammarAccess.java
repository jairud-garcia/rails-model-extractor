...
@Singleton
public class SchemaGrammarAccess extends AbstractGrammarElementFinder {
	
	public class SchemaElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.Schema");
	...
	public class SchemaMemberElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.SchemaMember");
	...
	public class TableElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.Table");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TableAttributesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.TableAttributes");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class IgnoredHashKeyValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.IgnoredHashKeyValue");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class IndexElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.Index");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	@Inject
	public SchemaGrammarAccess(GrammarProvider grammarProvider) {
		...
		this.tCOMMA = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.COMMA");
		this.tSPACE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.SPACE");
		this.tBRACKET_BLOCK_ALONE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.BRACKET_BLOCK_ALONE");
		this.tARRAY_BLOCK = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.ARRAY_BLOCK");
		this.tPARENTHESIS_BLOCK = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.PARENTHESIS_BLOCK");
		this.tDO_WORD = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.DO_WORD");
		this.tEND_WORD = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.END_WORD");
		this.tBLOCK_PARAMS = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.BLOCK_PARAMS");
		this.tSYMBOL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.SYMBOL");
		this.tID = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.ID");
		this.tSTRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.STRING");
		this.tML_COMMENT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.ML_COMMENT");
		this.tSL_COMMENT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.SL_COMMENT");
		this.tINT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.INT");
		this.tDECIMAL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.DECIMAL");
		this.tBS = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.BS");
		this.tANY_OTHER = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "co.gruposaberes.rails.parser.Schema.ANY_OTHER");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("co.gruposaberes.rails.parser.Schema".equals(grammar.getName())) {
				return grammar;
			}
