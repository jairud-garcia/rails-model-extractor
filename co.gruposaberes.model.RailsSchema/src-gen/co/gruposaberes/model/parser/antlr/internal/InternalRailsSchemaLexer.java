...
public class InternalRailsSchemaLexer extends Lexer {
    ...
    public final void mRULE_COMMA() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRailsSchema.g:525:12: ( ',' )
            // InternalRailsSchema.g:525:14: ','
            {
            match(','); 
    ...
    public final void mRULE_SPACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRailsSchema.g:527:12: ( ( ' ' | '\\f' ) )
            // InternalRailsSchema.g:527:14: ( ' ' | '\\f' )
            {
    ...
    public final void mRULE_BRACKET_BLOCK_ALONE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRailsSchema.g:529:26: ( '{' (~ ( ( '{' | '}' ) ) )* '}' )
            // InternalRailsSchema.g:529:28: '{' (~ ( ( '{' | '}' ) ) )* '}'
            {
            match('{'); 
            // InternalRailsSchema.g:529:32: (~ ( ( '{' | '}' ) ) )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_ARRAY_BLOCK() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRailsSchema.g:531:18: ( '[' (~ ( ']' ) )* ']' )
            // InternalRailsSchema.g:531:20: '[' (~ ( ']' ) )* ']'
            {
            match('['); 
            // InternalRailsSchema.g:531:24: (~ ( ']' ) )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_PARENTHESIS_BLOCK() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRailsSchema.g:533:24: ( '(' (~ ( ')' ) )* ')' )
            // InternalRailsSchema.g:533:26: '(' (~ ( ')' ) )* ')'
            {
            match('('); 
            // InternalRailsSchema.g:533:30: (~ ( ')' ) )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_DO_WORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRailsSchema.g:535:14: ( 'do' )
            // InternalRailsSchema.g:535:16: 'do'
            {
            match("do"); 
    ...
    public final void mRULE_END_WORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRailsSchema.g:537:15: ( 'end' )
            // InternalRailsSchema.g:537:17: 'end'
            {
            match("end"); 
    ...
    public final void mRULE_BLOCK_PARAMS() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRailsSchema.g:539:19: ( '|' RULE_ID '|' )
            // InternalRailsSchema.g:539:21: '|' RULE_ID '|'
            {
            match('|'); 
            mRULE_ID(); 
            match('|'); 
    ...
    public final void mRULE_SYMBOL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRailsSchema.g:541:13: ( ':' RULE_ID )
            // InternalRailsSchema.g:541:15: ':' RULE_ID
            {
            match(':'); 
            mRULE_ID(); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRailsSchema.g:543:9: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalRailsSchema.g:543:11: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            ...
            // InternalRailsSchema.g:543:35: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRailsSchema.g:545:13: ( ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalRailsSchema.g:545:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalRailsSchema.g:545:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // InternalRailsSchema.g:545:16: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalRailsSchema.g:545:20: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
                        ...
                        switch (alt5) {
                    	case 1 :
                    	    // InternalRailsSchema.g:545:21: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    ...
                    break;
                case 2 :
                    // InternalRailsSchema.g:545:86: '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalRailsSchema.g:545:91: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                        ...
                        switch (alt6) {
                    	case 1 :
                    	    // InternalRailsSchema.g:545:92: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    	    if ( input.LA(1)=='\"'||input.LA(1)=='\''||input.LA(1)=='\\'||input.LA(1)=='b'||input.LA(1)=='f'||input.LA(1)=='n'||input.LA(1)=='r'||(input.LA(1)>='t' && input.LA(1)<='u') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRailsSchema.g:547:17: ( '=begin' ( options {greedy=false; } : . )* '=end' )
            // InternalRailsSchema.g:547:19: '=begin' ( options {greedy=false; } : . )* '=end'
            {
            match("=begin"); 

            // InternalRailsSchema.g:547:28: ( options {greedy=false; } : . )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRailsSchema.g:549:17: ( '#' ( options {greedy=false; } : . )* '\\n' )
            // InternalRailsSchema.g:549:19: '#' ( options {greedy=false; } : . )* '\\n'
            {
            match('#'); 
            // InternalRailsSchema.g:549:23: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRailsSchema.g:551:10: ( ( '0' .. '9' )+ )
            // InternalRailsSchema.g:551:12: ( '0' .. '9' )+
            {
            // InternalRailsSchema.g:551:12: ( '0' .. '9' )+
            int cnt10=0;
            loop10:
            do {
                ...
                switch (alt10) {
            	case 1 :
            	    // InternalRailsSchema.g:551:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_DECIMAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRailsSchema.g:553:14: ( RULE_INT '.' RULE_INT )
            // InternalRailsSchema.g:553:16: RULE_INT '.' RULE_INT
            {
            mRULE_INT(); 
            match('.'); 
            mRULE_INT(); 
    ...
    public final void mRULE_BS() throws RecognitionException {
        try {
            int _type = RULE_BS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRailsSchema.g:555:9: ( ( '\\t' | '\\n' ) )
            // InternalRailsSchema.g:555:11: ( '\\t' | '\\n' )
            {
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRailsSchema.g:557:16: ( . )
            // InternalRailsSchema.g:557:18: .
            {
            matchAny(); 
